import { getEmailConfig, getEmailModels } from "@/lib/email";
import TestEmailForm from "@/components/admin/TestEmailForm";
import EmailModels from "@/components/admin/EmailModels";
...
export default function EmailTestePage() {
  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="mt-6">
        <EmailModels models={models} defaultTo={cfg.admin || cfg.from} />
      </div>
    </div>
  );
}
