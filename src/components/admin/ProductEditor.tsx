    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        ...
        <div className="card flex flex-col gap-4 p-6">
          ...
          <Field label="Link no Mercado Livre (opcional)">
            <input
              value={p.mercadoLivreUrl}
              onChange={(e) => set("mercadoLivreUrl", e.target.value)}
              placeholder="https://produto.mercadolivre.com.br/MLB-..."
              className={inputCls}
            />
            <span className="mt-1 block text-[11px] text-gray-500">
              Se preenchido, aparece um botão na página do produto oferecendo a compra pelo Mercado Livre
              (ajuda a converter quem ainda não confia numa loja nova). Deixe vazio para não exibir.
            </span>
          </Field>
